...
format=hw.DeviceInfo(pos).SupportedFormats;
set(handles.formatos,'String',format)
list_f = [format{1:end}];
...
% Hints: get(hObject,'String') returns contents of formatos as text
%        str2double(get(hObject,'String')) returns contents of formatos as a double
